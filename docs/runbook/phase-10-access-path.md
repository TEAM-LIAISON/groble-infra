...
| **선행 조건** | [Phase 4](./phase-04-monitoring-node-rebuild.md)·[7](./phase-07-dev-cache-asg.md)·[9](./phase-09-prod-asg.md)에서 **SSM 접속이 실제로 검증되어 있어야 한다** |
| **되돌리기** | SG 규칙 복원 |
...
4. **SG 정리**
   ...
   - `trusted_ips` 변수 폐기
5. **키페어 의존 제거** — launch template에서 `key_name` 제외 ([Phase 7](./phase-07-dev-cache-asg.md)·[9](./phase-09-prod-asg.md)에서 이미 제외했다면 확인만)
