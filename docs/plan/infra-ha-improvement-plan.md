...
| [`runbook/README.md`](../runbook/README.md) | 어떤 순서로 안전하게 이관하는가 (목차·공통 원칙, Phase별 상세는 [`runbook/`](../runbook/)) |
...
동적 스케일링([향후 개선 Low-3](./infra-future-improvements.md#low-3-동적-오토스케일링))의 트리거 조건과는 아직 거리가 멀다.
