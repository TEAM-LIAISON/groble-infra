...
| **상태** | 📦 **종결** |
| **종결일** | 2026-08-30 |
| **결과** | 검증용 그린이 2026-08-29 운영으로 전환되어 이 엔드포인트는 존재하지 않는다 |

---

> 📦 **종결된 안내문이다.** 여기 적힌 엔드포인트는 **더 이상 존재하지 않는다.**
> 그린이 운영으로 전환되었으므로, 현재 운영 DB 접속은
> [`CLAUDE.md`](../../../CLAUDE.md) 의 SSH 터널 안내를 따른다.
