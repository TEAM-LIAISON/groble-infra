...
**외부 사정으로 촉발되어 Phase 순서에 끼워 넣는 작업이다.** [`runbook/adhoc/`](./runbook/adhoc/) 에 있다.
Phase 와 같은 "실행 절차" 문서지만 번호가 없고, 대신 **어느 Phase 와 자원이 겹치는지**를 헤더에 밝힌다 —
그것이 끼워 넣을 수 있는 시점을 결정한다.

| 작업 | 촉발 | 겹치는 Phase | 상태 |
|---|---|---|---|
| [RDS MySQL 8.0 → 8.4](./runbook/adhoc/rds-mysql-84-upgrade.md) | 2026-08-01 부터 확장 지원 과금 월 $178.56 자동 부과 | **없음** — RDS 인스턴스만 건드린다 | 📦 **종결** (2026-08-29) — 사후 확인 3건 남음 |
